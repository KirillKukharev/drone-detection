...
def get_latest_run(search_dir='.'):
    # Return path to most recent 'yolov5n6_ext_last.pt' in /runs (i.e. to --resume from)
...
def strip_optimizer(f='yolov5n6_ext_best.pt', s=''):  # from utils.general import *; strip_optimizer()
